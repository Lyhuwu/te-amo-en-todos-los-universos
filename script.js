...
const defaultHeartImages = Array.from({ length: 13 }, (_, i) => `images/img${i + 1}.jpg`);
...
function preloadGalaxyAudio() {
  const audioSources = [
   "https://lyhuwu.github.io/te-amo-en-todos-los-universos/music/serendipiaa.mp3"
  ];
